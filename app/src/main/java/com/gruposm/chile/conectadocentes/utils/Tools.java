...
public class Tools {
    ...
    public static long getDateTime(String dateStr, String format) {
        ...
        try {
            Date mDate = newFormat.parse(dateStr);
    ...
    public static String getCurrentDateTimeMysql()
    {
        ...
        long dateTime = cur_calender.getTimeInMillis();
        SimpleDateFormat newFormat = new SimpleDateFormat("yyyy-MM-dd hh:mm:ss");
        return newFormat.format(new Date(dateTime));
    }
    public static String getFormattedDateMysql(Long dateTime) {
    ...
    public static String getFormattedTimeMysql(Long time) {
