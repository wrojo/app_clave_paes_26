package com.gruposm.chile.conectadocentes.fragments;
...
import com.gruposm.chile.conectadocentes.services.ReleaseQuiz;
import com.gruposm.chile.conectadocentes.utils.CallBackDialog;
import com.gruposm.chile.conectadocentes.utils.CallBackRelease;
            ...
            public void onClick(View v) {
                ...
                ReleaseQuiz releaseQuiz = new ReleaseQuiz(context, data, new CallBackRelease() {
                    ...
                    public void onErrorUnauthorized() {
                        ...
                        Util.logoutAndRedirect(context);
                    }
                });
