...
import com.gruposm.chile.appclavepaes26.services.Login;
import com.gruposm.chile.appclavepaes26.services.SyncroDB;
import com.gruposm.chile.appclavepaes26.utils.CallBackLogin;
import com.gruposm.chile.appclavepaes26.utils.CallBackSyncro;
import com.gruposm.chile.appclavepaes26.utils.SessionManager;
import com.gruposm.chile.appclavepaes26.utils.SessionSyncro;
                    ...
                    if (!mRut.isEmpty() && !mDv.isEmpty() && !mPass.isEmpty()) {
                        Login login =  new Login(LoginActivity.this,mRut,mDv,mPass, new CallBackLogin() {
                            ...
                            public void onSucess(User user) {
                                progress.dismiss();
                                session.createSession(user.getNombre(),user.getEmail(),user.getIdUsuario(),user.getAvatar(),user.getRol(),user.getToken(),user.getUnique());
