package com.gruposm.chile.appclavepaes26.detection;
...
import com.gruposm.chile.appclavepaes26.drawing.DrawOverScreen;
import com.gruposm.chile.appclavepaes26.object.AnswerSheet;
import com.gruposm.chile.appclavepaes26.object.Mark;
import com.gruposm.chile.appclavepaes26.object.Quiz;
import com.gruposm.chile.appclavepaes26.utils.OmrUtil;
...
public class DetectionUtil {
    ...
    public DetectionUtil(Quiz quiz)
    {
        ...
        this.isErrorDetection = answerSheet.setCorrects(quiz.getCorrectas());
    ...
    public Map<String, String> printResult()
    {
        ...
        results.put("total",String.valueOf(answerSheet.getNumAnswers()));
