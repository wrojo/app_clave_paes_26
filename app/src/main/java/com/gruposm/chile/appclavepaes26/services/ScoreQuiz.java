...
import com.gruposm.chile.appclavepaes26.utils.CallBackScore;
...
public class ScoreQuiz {
    ...
    public  ScoreQuiz(Context context, List<Inbox> results, CallBackScore callBack)
    {
        ...
        this.getData(results, callBack);
    }
    private void getData(List<Inbox> results,final CallBackScore callBack)
    {
